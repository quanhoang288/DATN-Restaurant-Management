      ...
      setOrderData({
        ...
        orderItems:
          quantity === 0
            ...
            : orderData.orderItems.map((i) => (i.id === itemId ? { ...i, quantity } : i)),
      })
    },
    [orderData]
  )
      ...
      <CustomerMain includeFooter={false}>
          ...
          <Card style={{ marginBottom: '2rem', marginTop: '1rem' }}>
            ...
            <CardContent>
              <FormGroup style={{ marginBottom: '2rem' }}>
                ...
                <TextField fullWidth variant='outlined' style={{ marginTop: 10 }} />
              </FormGroup>
              <FormGroup>
                  ...
                  <>
                    <ListItem alignItems='center'>
                      <div style={{ display: 'flex', alignItems: 'center', marginRight: 10 }}>
                        <IconButton size='medium' onChange={() => handleUpdateItemQuantity(item.id, item.quantity - 1)}>
                          <RemoveIcon />
                        </IconButton>
              ...
              <div style={{ padding: '1rem 1rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
                  ...
                  <Typography style={{ fontWeight: 500 }}>
                    {orderData.orderItems.reduce((prevTotal, item) => prevTotal + item.sale_price * item.quantity, 0)}
                  </Typography>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography>Phí áp dụng</Typography>
                  <Typography style={{ fontWeight: 500 }}>43000</Typography>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <FormGroup>
                ...
                <TextField value='cash' fullWidth select variant='outlined' style={{ marginTop: 10 }}>
        ...
        >
          <div>
            ...
            <Typography style={{ fontSize: 20, fontWeight: 500 }}>150000</Typography>
          </div>

          <Button
            variant='contained'
            onClick={handleCreateOrder}
            style={{ background: 'green', color: 'white', minWidth: 200, minHeight: 50, marginLeft: '2rem' }}
          >
            Đặt đơn
          </Button>
        </div>
