...
import { Avatar, MenuItem, ListItemIcon, ListItemText, IconButton } from '@material-ui/core'
  ...
  return (
    <>
      <IconButton ref={anchorRef} onClick={handleOpen}>
        <Avatar
          //   src={user && user.avatar ? `${ASSET_BASE_URL}/${user.avatar.fileName}` : `${ASSET_BASE_URL}/no_avatar.jpg`}
